...
const PostUser1 = ({ post, onDelete }) => {
  ...
  const handleDeleteComment = useCallback(async (deletedCommentId) => {
    ...
    try {
      ...
      // Only revert for non-404 errors
  ...
  const handleDelete = async () => {
    try {
      await axios.delete(`https://mern-application-w42i.onrender.com/posts/${post._id}`, {
        withCredentials: true,
      });
  ...
  return (
    <div className="relative max-w-2xl mx-auto px-4 py-3 border-b border-gray-300 hover:bg-gray-50 transition">
      ...
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1">
          ...
          {isCommentsFetching ? (
            <div className="mt-4 text-gray-500 text-sm">Loading comments...</div>
          ) : comments.length > 0 ? (
            <div className="mt-4">
